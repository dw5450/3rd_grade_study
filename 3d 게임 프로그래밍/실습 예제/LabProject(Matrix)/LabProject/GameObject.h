...
public:
	...
	static CMatrix LookAtLH(CVector3& vPosition, CVector3& vLookAt, CVector3& vUp);					//카메라 포지선, 바라보는곳 포지선, 월드 벡터의 업벡터.6
...
public:
	...
	CMatrix					m_mtxView;         									//카메라 행렬의 역행렬
    CMatrix					m_mtxProjection;									//원근 투영을 위한 행렬, 나누기 연산 아닙니다!
	CMatrix					m_mtxViewProject;									// m_mtxView * m_mtxProjection

	VIEWPORT				m_d3dViewport;										//화면 크기 저장
