...
bool CGameFramework::OnCreate(HINSTANCE hInstance, HWND hMainWnd)
{
	...
	m_pCamera->SetLookAt(CVector3(0.0f, 0.0f, -30.0f), CVector3(0.0f, 0.0f, 0.0f), CVector3(0.0f, 1.0f, 0.0f));
...
void CGameFramework::BuildFrameBuffer()
{
	...
	m_hBitmapFrameBuffer = ::CreateCompatibleBitmap(hDC, m_pCamera->m_d3dViewport.m_nWidth, m_pCamera->m_d3dViewport.m_nHeight);
...
void CGameFramework::ClearFrameBuffer(DWORD dwColor)
{
	...
	::Rectangle(m_hDCFrameBuffer, m_pCamera->m_d3dViewport.m_xStart, m_pCamera->m_d3dViewport.m_yStart, m_pCamera->m_d3dViewport.m_nWidth, m_pCamera->m_d3dViewport.m_nHeight);
...
{    
    HDC hDC = ::GetDC(m_hWnd);
    ::BitBlt(hDC, m_pCamera->m_d3dViewport.m_xStart, m_pCamera->m_d3dViewport.m_yStart, m_pCamera->m_d3dViewport.m_nWidth, m_pCamera->m_d3dViewport.m_nHeight, m_hDCFrameBuffer, m_pCamera->m_d3dViewport.m_xStart, m_pCamera->m_d3dViewport.m_yStart, SRCCOPY);
    ::ReleaseDC(m_hWnd, hDC);
}
...
void CGameFramework::BuildObjects()
{
	...
	m_pObjects[0].SetRotationAxis(CVector3(0.0f, 0.0f, 1.0f));
	m_pObjects[0].SetRotationSpeed(0.04f);
    m_pObjects[1].SetMesh(pCubeMesh);
	m_pObjects[1].SetColor(RGB(0, 0, 255));
	m_pObjects[1].SetPosition(+13.5f, -2.0f, +14.0f);
	m_pObjects[1].SetRotationAxis(CVector3(1.0f, 1.0f, 0.0f));
	...
	m_pObjects[2].SetRotationAxis(CVector3(1.0f, 1.0f, 0.0f));
	m_pObjects[2].SetRotationSpeed(0.15f);
	m_pObjects[2].SetMovingDirection(CVector3(0.0f, -1.0f, 0.0f));
	...
	m_pObjects[3].SetRotationAxis(CVector3(0.0f, 1.0f, 1.0f));
	m_pObjects[3].SetRotationSpeed(0.06f);
	m_pObjects[3].SetMovingDirection(CVector3(0.0f, 0.0f, 1.0f));
